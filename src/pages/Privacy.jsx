...
const Privacy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | StayZen</title>
      </Helmet>
      <div className="min-h-screen bg-gray-100 flex items-center justify-center px-6 py-12">
        <div className="max-w-4xl bg-white shadow-lg rounded-2xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 text-center mb-6">Privacy Policy</h1>
          ...
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-700">2. How We Use Your Information</h2>
            ...
            {/* Data Security */}
            <div>
              <h2 className="text-2xl font-semibold text-gray-700">3. Data Security</h2>
              <p className="text-gray-600 mt-2">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-700">4. Cookies and Tracking</h2>
              <p className="text-gray-600 mt-2">
            ...
            {/* Your Rights */}
            <div>
              <h2 className="text-2xl font-semibold text-gray-700">6. Your Rights</h2>
              <p className="text-gray-600 mt-2">
