...
const Terms = () => {
  return (
    <>
      <Helmet>
        <title>Terms & Conditions | StayZen</title>
      </Helmet>
      <div className="min-h-screen bg-gray-100 flex items-center justify-center px-6 py-12">
        <div className="max-w-4xl bg-white shadow-lg rounded-2xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 text-center mb-6">Terms & Conditions</h1>
          ...
          <div className="space-y-6">
            ...
            {/* Booking & Payments */}
            <div>
              <h2 className="text-2xl font-semibold text-gray-700">3. Booking & Payments</h2>
              <p className="text-gray-600 mt-2">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-700">4. Cancellations & Refunds</h2>
              <p className="text-gray-600 mt-2">
