    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-6 py-12">
        <div className="max-w-4xl shadow-lg rounded-2xl p-8">
          <h1 className="text-4xl font-bold text-center mb-6">About StayZen</h1>
          ...
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-semibold">Why Choose StayZen?</h2>
          ...
          <div className="mt-8 text-center">
            <p className="text-lg font-semibold">📍 Explore. Book. Stay Zen.</p>
          </div>
        </div>
      </div>
    </>
