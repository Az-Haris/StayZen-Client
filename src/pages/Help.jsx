    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center px-6 py-12">
        <div className="max-w-4xl bg-white shadow-lg rounded-2xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 text-center mb-6">Help & Support</h1>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg shadow">
                  <h3 className="font-semibold text-lg text-gray-800">2. What is the cancellation policy?</h3>
                  <p className="text-gray-600 mt-1">
                    Cancellation policies vary by property. Check the cancellation terms before booking.
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg shadow">
                  <h3 className="font-semibold text-lg text-gray-800">3. How do I contact customer support?</h3>
                  <p className="text-gray-600 mt-1">
            ...
            {/* Contact Support */}
            <div>
              <h2 className="text-2xl font-semibold text-gray-700">Contact Support</h2>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-700">Troubleshooting</h2>
              <ul className="list-disc list-inside text-gray-600 mt-2 space-y-2">
