...
const ThemeController = () => {
  ...
  // Load the saved theme from localStorage or fallback to the default theme
  useEffect(() => {
  ...
  // Toggle between themes and save preference to localStorage
  const toggleTheme = () => {
  ...
  return (
    <label className="swap swap-rotate">
      ...
      <input
        type="checkbox"
        checked={theme === 'mytheme'} // Checkbox state reflects the current theme
